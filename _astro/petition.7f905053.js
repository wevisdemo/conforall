 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pi="FirebaseError";class yt extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=Pi,Object.setPrototypeOf(this,yt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Kr.prototype.create)}}class Kr{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,i=this.errors[e],o=i?xi(i,r):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new yt(s,a,r)}}function xi(n,e){return n.replace(Di,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const Di=/\{\$([^}]+)}/g;function Sn(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const i=n[s],o=e[s];if(ir(i)&&ir(o)){if(!Sn(i,o))return!1}else if(i!==o)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function ir(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yi{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Ji(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function Ji(n){const e=n.getComponent();return e?.type==="VERSION"}const xn="@firebase/app",cr="0.9.15";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dn="[DEFAULT]",To={[xn]:"fire-core",[Xi]:"fire-core-compat",[eo]:"fire-analytics",[Qi]:"fire-analytics-compat",[no]:"fire-app-check",[to]:"fire-app-check-compat",[ro]:"fire-auth",[so]:"fire-auth-compat",[io]:"fire-rtdb",[oo]:"fire-rtdb-compat",[ao]:"fire-fn",[lo]:"fire-fn-compat",[co]:"fire-iid",[uo]:"fire-iid-compat",[ho]:"fire-fcm",[fo]:"fire-fcm-compat",[po]:"fire-perf",[mo]:"fire-perf-compat",[go]:"fire-rc",[_o]:"fire-rc-compat",[vo]:"fire-gcs",[bo]:"fire-gcs-compat",[yo]:"fire-fst",[Eo]:"fire-fst-compat","fire-js":"fire-js",[wo]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xo=Ao;function Xr(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Dn,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw it.create("bad-app-name",{appName:String(s)});if(t||(t=Gr()),!t)throw it.create("no-options");const i=Qt.get(s);if(i){if(Sn(t,i.options)&&Sn(r,i.config))return i;throw it.create("duplicate-app",{appName:s})}const o=new Li(s);for(const l of kn.values())o.addComponent(l);const a=new Po(t,r,o);return Qt.set(s,a),a}function Do(n=Dn){const e=Qt.get(n);if(!e&&n===Dn&&Gr())return Xr();if(!e)throw it.create("no-app",{appName:n});return e}function gt(n,e,t){var r;let s=(r=To[n])!==null&&r!==void 0?r:n;t&&(s+=`-${t}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${s}" with version "${e}":`];i&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ht.warn(a.join(" "));return}en(new Lt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $o(n){en(new Lt("platform-logger",e=>new Yi(e),"PRIVATE")),en(new Lt("heartbeat",e=>new Mo(e),"PRIVATE")),gt(xn,cr,n),gt(xn,cr,"esm2017"),gt("fire-js","")}$o("");var Bo="firebase",Uo="10.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fr="ok",Ho="cancelled",Pt="unknown",U="invalid-argument",zo="deadline-exceeded",Wo="not-found",qo="permission-denied",Rn="unauthenticated",Go="resource-exhausted",bt="failed-precondition",Ko="aborted",Zo="out-of-range",Yo="unimplemented",Jo="internal",Xo="unavailable";class D extends yt{constructor(e,t){super(e,t),this.code=e,this.message=t,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ln{constructor(e){this.value=e}static empty(){return new ln({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!wn(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=xt(t)}setAll(e){let t=Ve.emptyPath(),r={},s=[];e.forEach((o,a)=>{if(!t.isImmediateParentOf(a)){const l=this.getFieldsMap(t);this.applyChanges(l,r,s),r={},s=[],t=a.popLast()}o?r[a.lastSegment()]=xt(o):s.push(a.lastSegment())});const i=this.getFieldsMap(t);this.applyChanges(i,r,s)}delete(e){const t=this.field(e.popLast());wn(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Ln(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];wn(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){zn(t,(s,i)=>e[s]=i);for(const s of r)delete e[s]}clone(){return new ln(xt(this.value))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kt=new Map;function Ra(n){if(n._terminated)throw new D(bt,"The client has already been terminated.");if(!kt.has(n)){tn("ComponentProvider","Initializing Datastore");const e=function(i){return new ua(i,fetch.bind(null))}(function(i,o,a,l){return new oa(i,o,a,l.host,l.ssl,l.experimentalForceLongPolling,l.experimentalAutoDetectLongPolling,os(l.experimentalLongPollingOptions),l.useFetchStreams)}(n._databaseId,n.app.options.appId||"",n._persistenceKey,n._freezeSettings())),t=Wn(n._databaseId),r=function(i,o,a,l){return new Da(i,o,a,l)}(n._authCredentials,n._appCheckCredentials,e,t);kt.set(n,r)}return kt.get(n)}class Tr{constructor(e){var t,r;if(e.host===void 0){if(e.ssl!==void 0)throw new D(U,"Can't provide ssl option if host option is not set");this.host="firestore.googleapis.com",this.ssl=!0}else this.host=e.host,this.ssl=(t=e.ssl)===null||t===void 0||t;if(this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=41943040;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<1048576)throw new D(U,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}(function(i,o,a,l){if(o===!0&&l===!0)throw new D(U,`${i} and ${a} cannot be used together.`)})("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=os((r=e.experimentalLongPollingOptions)!==null&&r!==void 0?r:{}),function(i){if(i.timeoutSeconds!==void 0){if(isNaN(i.timeoutSeconds))throw new D(U,`invalid long polling timeout: ${i.timeoutSeconds} (must not be NaN)`);if(i.timeoutSeconds<5)throw new D(U,`invalid long polling timeout: ${i.timeoutSeconds} (minimum allowed value is 5)`);if(i.timeoutSeconds>30)throw new D(U,`invalid long polling timeout: ${i.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&function(r,s){return r.timeoutSeconds===s.timeoutSeconds}(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class mn{constructor(e,t,r,s){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=r,this._app=s,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new Tr({}),this._settingsFrozen=!1}get app(){if(!this._app)throw new D(bt,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!==void 0}_setSettings(e){if(this._settingsFrozen)throw new D(bt,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new Tr(e),e.credentials!==void 0&&(this._authCredentials=function(r){if(!r)return new Qo;switch(r.type){case"firstParty":return new ra(r.sessionIndex||"0",r.iamToken||null,r.authTokenFactory||null);case"provider":return r.client;default:throw new D(U,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask||(this._terminateTask=this._terminate()),this._terminateTask}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(t){const r=kt.get(t);r&&(tn("ComponentProvider","Removing Datastore"),kt.delete(t),r.terminate())}(this),Promise.resolve()}}function Oa(n,e){const t=typeof n=="object"?n:Do(),r=typeof n=="string"?n:e||"(default)",s=So(t,"firestore/lite").getImmediate({identifier:r});if(!s._initialized){const i=Ai("firestore");i&&La(s,...i)}return s}function La(n,e,t,r={}){var s;const i=(n=is(n,mn))._getSettings(),o=`${e}:${t}`;if(i.host!=="firestore.googleapis.com"&&i.host!==o&&ns("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),n._setSettings(Object.assign(Object.assign({},i),{host:o,ssl:!1})),r.mockUserToken){let a,l;if(typeof r.mockUserToken=="string")a=r.mockUserToken,l=Ie.MOCK_USER;else{a=Ii(r.mockUserToken,(s=n._app)===null||s===void 0?void 0:s.options.projectId);const c=r.mockUserToken.sub||r.mockUserToken.user_id;if(!c)throw new D(U,"mockUserToken must contain 'sub' or 'user_id' field!");l=new Ie(c)}n._authCredentials=new ea(new rs(a,l))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $t{constructor(e){this._byteString=e}static fromBase64String(e){try{return new $t(Xe.fromBase64String(e))}catch(t){throw new D(U,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new $t(Xe.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hs{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new D(U,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ve(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function qa(n,e,t){let r;return r=n?t&&(t.merge||t.mergeFields)?n.toFirestore(e,t):n.toFirestore(e):e,r}function Ga(n,e){const t=Ma(n=is(n,Ze)),r=qa(n.converter,e),s=Ua(Ba(n.firestore),"addDoc",t._key,r,t.converter!==null,{});return ka(Ra(n.firestore),[s.toMutation(t._key,Dt.exists(!1))]).then(()=>t)}(function(){(function(t){Et=t})(`${xo}_lite`),en(new Lt("firestore/lite",(e,{instanceIdentifier:t,options:r})=>{const s=e.getProvider("app").getImmediate(),i=new mn(new ta(e.getProvider("auth-internal")),new ia(e.getProvider("app-check-internal")),function(a,l){if(!Object.prototype.hasOwnProperty.apply(a.options,["projectId"]))throw new D(U,'"projectId" not provided in firebase.initializeApp.');return new rn(a.options.projectId,l)}(s,t),s);return r&&i._setSettings(r),i},"PUBLIC").setMultipleInstances(!0)),gt("firestore-lite","4.1.0",""),gt("firestore-lite","4.1.0","esm2017")})();const Ka=Hr({apiKey:Le(),authDomain:Le(),projectId:Le(),storageBucket:Le(),messagingSenderId:Le(),appId:Le()}),Za="documents",Ya=In(Ka,JSON.parse('{"apiKey":"AIzaSyBYGz_WUwzIpZYGf4SN4jo5xqp3MNEC8FA","authDomain":"conforall.firebaseapp.com","projectId":"conforall","storageBucket":"conforall.appspot.com","messagingSenderId":"289133639309","appId":"1:289133639309:web:b6ddf29928a923028214c4"}')),Ja=Xr(Ya),Xa=Oa(Ja),Qa=n=>Ga(Va(Xa,Za),n);function el(n){let e,t='<span class="label-text heading-03">เลขประจำตัวประชาชน*</span>',r,s,i,o,a,l,c,h;return{c(){e=T("label"),e.innerHTML=t,r=te(),s=T("input"),o=te(),a=T("div"),l=T("span"),c=Ye("ใส่เลขประจำตัวประชาชน 13 หลักไม่ต้องเว้นวรรค"),this.h()},l(u){e=I(u,"LABEL",{class:!0,for:!0,"data-svelte-h":!0}),ve(e)!=="svelte-9g4zpn"&&(e.innerHTML=t),r=ne(u),s=I(u,"INPUT",{type:!0,name:!0,class:!0}),o=ne(u),a=I(u,"DIV",{class:!0});var d=O(a);l=I(d,"SPAN",{class:!0});var v=O(l);c=Je(v,"ใส่เลขประจำตัวประชาชน 13 หลักไม่ต้องเว้นวรรค"),v.forEach(g),d.forEach(g),this.h()},h(){f(e,"class","label"),f(e,"for","personalid"),f(s,"type","string"),f(s,"name","personalid"),f(s,"class",i="input rounded-sm bg-base-200 "+(n[14]?"input-error":"")),s.disabled=n[2],f(l,"class",h="label-text-alt "+(n[14]?"text-error":"")),f(a,"class","label")},m(u,d){R(u,e,d),R(u,r,d),R(u,s,d),R(u,o,d),R(u,a,d),A(a,l),A(l,c)},p(u,d){d&16384&&i!==(i="input rounded-sm bg-base-200 "+(u[14]?"input-error":""))&&f(s,"class",i),d&4&&(s.disabled=u[2]),d&16384&&h!==(h="label-text-alt "+(u[14]?"text-error":""))&&f(l,"class",h)},d(u){u&&(g(e),g(r),g(s),g(o),g(a))}}}function tl(n){let e,t='<span class="label-text heading-03">ชื่อ*</span>',r,s,i,o,a,l,c,h;return{c(){e=T("label"),e.innerHTML=t,r=te(),s=T("input"),o=te(),a=T("div"),l=T("span"),c=Ye("ระบุชื่อจริงเป็นภาษาไทย"),this.h()},l(u){e=I(u,"LABEL",{class:!0,for:!0,"data-svelte-h":!0}),ve(e)!=="svelte-i2bah3"&&(e.innerHTML=t),r=ne(u),s=I(u,"INPUT",{type:!0,name:!0,class:!0}),o=ne(u),a=I(u,"DIV",{class:!0});var d=O(a);l=I(d,"SPAN",{class:!0});var v=O(l);c=Je(v,"ระบุชื่อจริงเป็นภาษาไทย"),v.forEach(g),d.forEach(g),this.h()},h(){f(e,"class","label"),f(e,"for","firstname"),f(s,"type","text"),f(s,"name","firstname"),f(s,"class",i="input rounded-sm bg-base-200 w-full "+(n[14]?"input-error":"")),s.disabled=n[2],f(l,"class",h="label-text-alt "+(n[14]?"text-error":"")),f(a,"class","label")},m(u,d){R(u,e,d),R(u,r,d),R(u,s,d),R(u,o,d),R(u,a,d),A(a,l),A(l,c)},p(u,d){d&16384&&i!==(i="input rounded-sm bg-base-200 w-full "+(u[14]?"input-error":""))&&f(s,"class",i),d&4&&(s.disabled=u[2]),d&16384&&h!==(h="label-text-alt "+(u[14]?"text-error":""))&&f(l,"class",h)},d(u){u&&(g(e),g(r),g(s),g(o),g(a))}}}function nl(n){let e,t='<span class="label-text heading-03">นามสกุล*</span>',r,s,i,o,a,l,c,h;return{c(){e=T("label"),e.innerHTML=t,r=te(),s=T("input"),o=te(),a=T("div"),l=T("span"),c=Ye("ระบุนามสกุลเป็นภาษาไทย"),this.h()},l(u){e=I(u,"LABEL",{class:!0,for:!0,"data-svelte-h":!0}),ve(e)!=="svelte-1lqzuwh"&&(e.innerHTML=t),r=ne(u),s=I(u,"INPUT",{type:!0,name:!0,class:!0}),o=ne(u),a=I(u,"DIV",{class:!0});var d=O(a);l=I(d,"SPAN",{class:!0});var v=O(l);c=Je(v,"ระบุนามสกุลเป็นภาษาไทย"),v.forEach(g),d.forEach(g),this.h()},h(){f(e,"class","label"),f(e,"for","lastname"),f(s,"type","text"),f(s,"name","lastname"),f(s,"class",i="input rounded-sm bg-base-200 "+(n[14]?"input-error":"")),s.disabled=n[2],f(l,"class",h="label-text-alt "+(n[14]?"text-error":"")),f(a,"class","label")},m(u,d){R(u,e,d),R(u,r,d),R(u,s,d),R(u,o,d),R(u,a,d),A(a,l),A(l,c)},p(u,d){d&16384&&i!==(i="input rounded-sm bg-base-200 "+(u[14]?"input-error":""))&&f(s,"class",i),d&4&&(s.disabled=u[2]),d&16384&&h!==(h="label-text-alt "+(u[14]?"text-error":""))&&f(l,"class",h)},d(u){u&&(g(e),g(r),g(s),g(o),g(a))}}}function rl(n){let e,t,r=`คลิกเพื่อกรอกลายเซ็น
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8.33332 0C5.40622 0 3 2.28256 3 5.53844C3 6.70035 3.27369 7.50866 3.78205 8.40382L7.97434 15.7884C8.00983 15.8525 8.06184 15.9059 8.12497 15.9432C8.1881 15.9804 8.26004 16 8.33332 16C8.4066 16 8.47854 15.9804 8.54166 15.9432C8.60479 15.9059 8.6568 15.8525 8.69229 15.7884L12.8846 8.40382C13.393 7.50864 13.6666 6.70035 13.6666 5.53844C13.6666 2.28256 11.2604 0 8.33332 0ZM8.33332 0.82051C10.8441 0.82051 12.8461 2.67673 12.8461 5.53844C12.8461 6.58135 12.6437 7.17112 12.173 7.99999L8.33332 14.7564L4.49359 7.99999C4.02289 7.17114 3.82051 6.58135 3.82051 5.53844C3.82051 2.67673 5.82255 0.82051 8.33332 0.82051ZM8.33332 3.28204C9.47107 3.28204 10.3846 4.19558 10.3846 5.33332C10.3846 6.47104 9.47106 7.38459 8.33332 7.38459C7.19557 7.38459 6.28204 6.47104 6.28204 5.33332C6.28204 4.19558 7.19557 3.28204 8.33332 3.28204Z" fill="white"></path></svg></a>`,o,a,l="หรือ",c,h,u=`<h1 class="heading-responsive-01 mb-3">วิธีที่ 2 : ดาวน์โหลดแบบฟอร์มมากรอก</h1> <div class="border-t grid gap-2 py-5"><p class="heading-03">1. ดาวน์โหลดแบบฟอร์ม และพิมพ์ลงกระดาษ A4</p> <a target="_blank" href="https://pin.ski/3Qtz6l3" class="btn btn-block btn-primary text-[16px] normal-case heading-03 text-base-100">ดาวน์โหลดแบบฟอร์ม
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" fill="transparent" style="mix-blend-mode:multiply"></rect><path d="M13.5 1.5H2.5C2.23478 1.5 1.98043 1.60536 1.79289 1.79289C1.60536 1.98043 1.5 2.23478 1.5 2.5V13.5C1.5 13.7652 1.60536 14.0196 1.79289 14.2071C1.98043 14.3946 2.23478 14.5 2.5 14.5H13.5C13.7652 14.5 14.0196 14.3946 14.2071 14.2071C14.3946 14.0196 14.5 13.7652 14.5 13.5V2.5C14.5 2.23478 14.3946 1.98043 14.2071 1.79289C14.0196 1.60536 13.7652 1.5 13.5 1.5ZM13.5 2.5V4.5H2.5V2.5H13.5ZM8.5 5.5H13.5V9H8.5V5.5ZM7.5 9H2.5V5.5H7.5V9ZM2.5 10H7.5V13.5H2.5V10ZM8.5 13.5V10H13.5V13.5H8.5Z" fill="white"></path></svg></a></div> <div class="border-t grid gap-2 py-5"><p class="heading-03">2. ลงลายมือชื่อบนแบบฟอร์ม</p> <p>ชวนคนใกล้ๆ ตัวมาร่วมลงชื่อให้เต็มแผ่นเลยก็ได้</p> <img class="mx-auto" src="/register-form.svg" alt="register-form"/></div> <div class="border-t grid gap-2 py-5"><p class="heading-03">3. ส่งเอกสารรวบรวมรายชื่อมายังสำนักงาน iLaw ภายในเวลา 20.00 น. ของวันที่ 20 สิงหาคม 2566</p> <div class="grid gap-1"><p>3.1. นำส่งด้วยตัวเองที่ iLaw</p> <a href="https://goo.gl/maps/PM5nXuVFUv5GCUZw7" class="link px-6 py-2 text-center text-accent font-bold heading-03 ">ดูแผนที่</a></div> <div class="grid gap-1"><p>3.2. ส่งไปรษณีย์ (ต้องใช้บริการไปรษณีย์ไทยเท่านั้น)</p> <p class="p-2 font-semibold bg-[#F2F2F2] text-center">ตู้ ปณ.79 ปณศ.สามเสนใน เขตพญาไท กรุงเทพฯ ประเทศไทย 10400 โทร. 0996786031</p></div> <div class="grid gap-1"><p>3.3. สแกนแล้วส่งอีเมลล์มาที่</p> <p class="p-2 font-semibold bg-[#F2F2F2] text-center">conforall66@gmail.com</p></div></div>`;return{c(){e=T("p"),e.textContent=t,r=te(),s=T("div"),s.innerHTML=i,o=te(),a=T("p"),a.textContent=l,c=te(),h=T("div"),h.innerHTML=u,this.h()},l(d){e=I(d,"P",{"data-svelte-h":!0}),ve(e)!=="svelte-ack3u8"&&(e.textContent=t),r=ne(d),s=I(d,"DIV",{class:!0,"data-svelte-h":!0}),ve(s)!=="svelte-x9jdd5"&&(s.innerHTML=i),o=ne(d),a=I(d,"P",{"data-svelte-h":!0}),ve(a)!=="svelte-nl1k6i"&&(a.textContent=l),c=ne(d),h=I(d,"DIV",{class:!0,"data-svelte-h":!0}),ve(h)!=="svelte-1f9yxyq"&&(h.innerHTML=u),this.h()},h(){f(s,"class","p-4 bg-base-100 grid gap-3 text-left"),f(h,"class","p-4 bg-base-100 text-left")},m(d,v){R(d,e,v),R(d,r,v),R(d,s,v),R(d,o,v),R(d,a,v),R(d,c,v),R(d,h,v)},i:nt,o:nt,d(d){d&&(g(e),g(r),g(s),g(o),g(a),g(c),g(h))}}}function pl(n){let e,t,r="ร่วมลงชื่อ",s,i,o,a,l,c,h,u,d,v,y,k,S,b,j,re,F;const be=[fl,dl],V=[];function oe(L,B){return L[0]?0:1}return S=oe(n),b=V[S]=be[S](n),{c(){e=T("div"),t=T("h3"),t.textContent=r,s=te(),i=T("div"),o=T("button"),a=Ye(`แบบกระดาษ
            `),l=Ue("svg"),c=Ue("path"),u=te(),d=T("button"),v=Ye("แบบออนไลน์"),k=te(),b.c(),this.h()},l(L){e=I(L,"DIV",{class:!0});var B=O(e);t=I(B,"H3",{class:!0,"data-svelte-h":!0}),ve(t)!=="svelte-l3nsqj"&&(t.textContent=r),s=ne(B),i=I(B,"DIV",{class:!0});var ae=O(i);o=I(ae,"BUTTON",{class:!0});var C=O(o);a=Je(C,`แบบกระดาษ
            `),l=je(C,"svg",{xmlns:!0,width:!0,height:!0,viewBox:!0,fill:!0});var W=O(l);c=je(W,"path",{d:!0,fill:!0}),O(c).forEach(g),W.forEach(g),C.forEach(g),u=ne(ae),d=I(ae,"BUTTON",{class:!0});var ie=O(d);v=Je(ie,"แบบออนไลน์"),ie.forEach(g),ae.forEach(g),k=ne(B),b.l(B),B.forEach(g),this.h()},h(){f(t,"class","heading-responsive-03"),f(c,"d","M11.5 3.33838C10.8584 3.33838 10.2311 3.5283 9.69722 3.88422C9.16336 4.24013 8.74678 4.7461 8.5 5.33838C8.25322 4.7461 7.83664 4.24013 7.30278 3.88422C6.76891 3.5283 6.14163 3.33838 5.5 3.33838C4.70435 3.33838 3.94129 3.65445 3.37868 4.21706C2.81607 4.77967 2.5 5.54273 2.5 6.33838C2.5 9.40088 8.5 14.3384 8.5 14.3384C8.5 14.3384 14.5 9.40088 14.5 6.33838C14.5 5.54273 14.1839 4.77967 13.6213 4.21706C13.0587 3.65445 12.2956 3.33838 11.5 3.33838Z"),f(c,"fill","black"),f(l,"xmlns","http://www.w3.org/2000/svg"),f(l,"width","17"),f(l,"height","17"),f(l,"viewBox","0 0 17 17"),f(l,"fill","none"),f(o,"class",h="btn join-item flex-1 heading-03 gap-1 py-2 px-6 "+(n[0]?"":"opacity-50")),f(d,"class",y="btn join-item flex-1 heading-03 gap-1 py-2 px-6 "+(n[0]?"opacity-50":"")),f(i,"class","join w-full"),f(e,"class","text-center grid gap-3 body-02-normal")},m(L,B){R(L,e,B),A(e,t),A(e,s),A(e,i),A(i,o),A(o,a),A(o,l),A(l,c),A(i,u),A(i,d),A(d,v),A(e,k),V[S].m(e,null),j=!0,re||(F=[Kt(o,"click",n[1]),Kt(d,"click",n[2])],re=!0)},p(L,[B]){(!j||B&1&&h!==(h="btn join-item flex-1 heading-03 gap-1 py-2 px-6 "+(L[0]?"":"opacity-50")))&&f(o,"class",h),(!j||B&1&&y!==(y="btn join-item flex-1 heading-03 gap-1 py-2 px-6 "+(L[0]?"opacity-50":"")))&&f(d,"class",y);let ae=S;S=oe(L),S!==ae&&(Sr(),Me(V[ae],1,1,()=>{V[ae]=null}),Cr(),b=V[S],b||(b=V[S]=be[S](L),b.c()),Ne(b,1),b.m(e,null))},i(L){j||(Ne(b),j=!0)},o(L){Me(b),j=!1},d(L){L&&g(e),V[S].d(),re=!1,Cs(F)}}}function ml(n,e,t){let r=!0;return[r,()=>t(0,r=!0),()=>t(0,r=!1)]}class yl extends Nn{constructor(e){super(),Fn(this,e,ml,pl,un,{})}}export{yl as default};
